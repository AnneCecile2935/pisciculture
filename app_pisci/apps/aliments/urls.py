...
from .views import AlimentCreateView, AlimentDeleteView, AlimentListView, AlimentUpdateView, AlimentListJsonView

app_name = "aliments"

urlpatterns = [
    path('json/', AlimentListJsonView.as_view(), name='list_json'),
